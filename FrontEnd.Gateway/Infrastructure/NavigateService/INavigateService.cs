...
namespace FrontEnd.Gateway.Infrastructure.NavigateService
{
    public interface INavigateService
    {
        ...
        Task<T> RequestAsync<T>(string uri, object item, bool readBody, string nameHttpClient, bool formatResponse = false, string httpMethod = null);
        Task<HttpResponseMessage> RequestStreamAsync(string uri, object item, bool readBody, string nameHttpClient, bool formatResponse = false);
